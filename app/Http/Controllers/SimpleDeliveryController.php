...
class SimpleDeliveryController extends Controller
{
    ...
    {
        return [
            ['class'=>'col-md-4', 'ftype'=>'input', 'name'=>'Nom', 'id'=>'name', 'placeholder'=>'Entrez le nom de la zone de livraison', 'required'=>true],
            ['class'=>'col-md-4', 'ftype'=>'input', 'type'=>'number', 'name'=>'Frais de livraison', 'id'=>'cost', 'placeholder'=>'Saisir les frais de livraison', 'required'=>true]
        ];
    }
