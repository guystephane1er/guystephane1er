...
<head>
	<script type='text/javascript' src='https://platform-api.sharethis.com/js/sharethis.js#property=60f695ee003943001ce6e985&product=sop' async='async'></script>
    <meta charset="utf-8" />
    ...
    <title>{{ config('global.site_name','WhatsMenu') }} - Commandez de la nourriture en ligne</title>
